...
describe MetaTags::ViewHelper do
  ...
  context 'displaying noindex' do
    it 'should display noindex when "noindex" used' do
      ...
      subject.display_meta_tags(:site => 'someSite').tap do |meta|
        expect(meta).to include('<meta content="noindex" name="robots" />')
      end
    end
    ...
    it 'should use custom noindex if given' do
      ...
      subject.display_meta_tags(:site => 'someSite').tap do |meta|
        expect(meta).to include('<meta content="noindex" name="some-noindex" />')
      end
    end

    it 'should display nothing by default' do
      subject.display_meta_tags(:site => 'someSite').tap do |meta|
        expect(meta).to_not include('<meta content="noindex"')
      end
    end
    ...
    it "should display nothing if given false" do
      ...
      subject.display_meta_tags(:site => 'someSite').tap do |meta|
        expect(meta).to_not include('<meta content="robots"')
      end
      subject.display_meta_tags(:site => 'someSite').tap do |meta|
        expect(meta).to_not include('<meta content="noindex"')
      end
  ...
  context 'displaying nofollow' do
    it 'should display nofollow when "nofollow" used' do
      ...
      subject.display_meta_tags(:site => 'someSite').tap do |meta|
        expect(meta).to include('<meta content="nofollow" name="robots" />')
      end
    end
    ...
    it 'should use custom nofollow if given' do
      ...
      subject.display_meta_tags(:site => 'someSite').tap do |meta|
        expect(meta).to include('<meta content="nofollow" name="some-nofollow" />')
      end
    end

    it 'should display nothing by default' do
      subject.display_meta_tags(:site => 'someSite').tap do |meta|
        expect(meta).to_not include('<meta content="nofollow"')
      end
    end
  end
  ...
  context 'displaying both nofollow and noindex' do
    it 'should be displayed when set using helpers' do
      ...
      subject.nofollow(true)
      subject.display_meta_tags(:site => 'someSite').tap do |meta|
        expect(meta).to include('<meta content="noindex, nofollow" name="robots" />')
      end
    end
    ...
    it 'should use custom name if string is used' do
      ...
      subject.display_meta_tags(:site => 'someSite').tap do |meta|
        expect(meta).to include('<meta content="noindex, nofollow" name="some-name" />')
      end
    end
