...
describe MetaTags::ViewHelper do
  ...
  context 'displaying title' do
    ...
    it 'should use custom separator if :separator' do
      ...
      subject.display_meta_tags(:site => 'someSite', :separator => '&mdash;').tap do |meta|
        expect(meta).to eq('<title>someSite &amp;mdash; someTitle</title>')
      end
      subject.display_meta_tags(:site => 'someSite', :separator => '&mdash;'.html_safe).tap do |meta|
        expect(meta).to eq('<title>someSite &mdash; someTitle</title>')
      end
